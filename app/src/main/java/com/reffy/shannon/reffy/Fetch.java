...
public class Fetch extends AsyncTask<String,Void,String>{
    ...
    // Constructor providing a reference to the views in ScannerActivity
    public Fetch(TextView titleText, TextView authorText, EditText bookInput) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            final String QUERY_PARAM = "isbn"; // Parameter for the search string.
